...
public class C_locommand implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if(yaku.equalsIgnoreCase("ピンゾロ")) sender.sendMessage(ChatColor.GREEN+"--"+yaku+"--");
        else if(yaku.equalsIgnoreCase("一二三")) sender.sendMessage(ChatColor.RED+"--"+yaku+"--");
        else if(yaku.equalsIgnoreCase("四五六")) sender.sendMessage(ChatColor.AQUA+"--"+yaku+"--");
        else if(yaku.equalsIgnoreCase("役無し")) sender.sendMessage("--"+yaku+"--");
